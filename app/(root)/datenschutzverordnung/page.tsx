  ...
  return (
    <section className="bg-primary-backgroundGreen py-12 px-4 lg:px-24">
      <div className="max-w-3xl mx-auto bg-white shadow-lg rounded-lg p-6 lg:p-12">
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-semibold text-primary-buttonGreen">
            Datenkontrolleur
          </h2>
          <p className="text-gray-700">Maria Zillinger</p>
          <p className="text-gray-700">Fit mit Mary</p>
          <p className="text-gray-700">info@fit-mit-mary.de</p>
        </div>

        <div className="mb-8">
          <h2 className="text-2xl font-semibold text-primary-buttonGreen mb-4">
            1. Datenschutz auf einen Blick
          </h2>
          <h3 className="text-xl font-semibold text-primary-buttonGreen mb-4">
            Allgemeine Hinweise
          </h3>
        ...
        <div className="mb-8">
          ...
          <p>
            ...
            Kommunikation können Ihre Zahlungsdaten, die Sie an uns übermitteln,
...
export default DatenschutzverordnungPage;
