...
const PersonalTrainingTable = () => {
  const headers = ["Angebot", "Dauer", "Preis"];
  const data = [
    [
      "Ersttermin inkl. Anamnese, Trainingsplanerstellung und individuellem Training",
      "90 Minuten",
      "€120",
    ],
    ["Folgetermin ohne Anamnese", "60 Minuten", "€75"],
...
export default PersonalTrainingTable;
